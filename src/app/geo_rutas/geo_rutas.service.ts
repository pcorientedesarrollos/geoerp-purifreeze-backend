// Contenido Completo y Final para: src/app/geo_rutas/geo_rutas.service.ts
...
// Interfaz para la ubicación de cada CLIENTE (usada en tu query)
...
export class GeoRutasService {
  constructor(
    ...
    // Inyección necesaria para la nueva funcionalidad de cálculo
  ...
  // ================================================================
  // MÉTODOS CRUD BÁSICOS (Respetando tu implementación)
  // ================================================================
  ...
  findAll(): Promise<GeoRutaEntity[]> {
    return this.geoRutaRepository.find({
      order: { idRuta: 'DESC' },
      // Se añaden relations para que los datos estén disponibles en otras funciones
  ...
  // ================================================================
  // TUS QUERYS PERSONALIZADAS (Respetadas 100%)
  // ================================================================
